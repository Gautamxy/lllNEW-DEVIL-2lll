...
module.exports.downLoad = function (url, type, api, event) {
    ...
    this.getLink(url).then(res => {
        ...
        axios({
            ...
            if (fs.statSync(path).size / 1024 / 1024 > 25) return api.sendMessage("The file is too big for your father to send again next time, take the file it's light dog",event.threadID, () => fs.unlinkSync(path), event.messageID);
