//** this is ayan-robot cmd enjoy this cmd **//
module.exports.config = {
  name: "bot",
  version: "2.0.0",
  permission: 0,
  credits: "AYAN",//don't change credits 
  description: "sms",
  prefix: true,
  category: "reply",
  usages: "chat sam bot",
